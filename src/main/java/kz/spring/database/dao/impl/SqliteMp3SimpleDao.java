...
//
//@Component("sqliteMp3SimpleDao")
//public class SqliteMp3SimpleDao implements MP3Dao {
//
...
//        this.insertMp3 = new SimpleJdbcInsert(dataSource).withTableName("track").usingColumns("name", "author_id");
//    }
//
//    @Override
...
//        if (nonNull(mp3.getId())) {
//            String sqlQuery = "update track set name=:name, author_id=:author_id where id=:id";
